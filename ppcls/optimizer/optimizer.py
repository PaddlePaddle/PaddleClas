...
class AdamWDL(object):
    ...
    class AdamWDL_Implement(optim.AdamW):
        def __init__(self,
                learning_rate=0.001,
                beta1=0.9,
                beta2=0.999,
            ...
            set_param_lr_fun = self._layerwise_lr_decay
        ...
        def _append_optimize_op(self, block, param_and_grad):
            ...
            # excute Adam op
            res = super(optim.AdamW, self)._append_optimize_op(block, param_and_grad)
    ...
    def __call__(self, model_list):
        ...
        opt_args = dict(learning_rate=self.learning_rate, weight_decay=self.weight_decay)
        ...
        optimizer = self.AdamWDL_Implement(**opt_args)
