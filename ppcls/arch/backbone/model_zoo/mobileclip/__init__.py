...
from paddle.vision.transforms import CenterCrop, Compose, Resize, ToTensor

sys.modules.setdefault("mobileclip", sys.modules[__name__])

from .clip import CLIP
from .modules.common.mobileone import reparameterize_model
from .modules.text.tokenizer import ClipTokenizer


def MobileCLIP2_S0(pretrained=False, use_ssld=False, **kwargs):
    return CLIP.from_variant("mobileclip2_s0", **kwargs)


def MobileCLIP2_S2(pretrained=False, use_ssld=False, **kwargs):
    return CLIP.from_variant("mobileclip2_s2", **kwargs)


def MobileCLIP2_S3(pretrained=False, use_ssld=False, **kwargs):
    return CLIP.from_variant("mobileclip2_s3", **kwargs)


def MobileCLIP2_S4(pretrained=False, use_ssld=False, **kwargs):
    return CLIP.from_variant("mobileclip2_s4", **kwargs)


def MobileCLIP2_B(pretrained=False, use_ssld=False, **kwargs):
    return CLIP.from_variant("mobileclip2_b", **kwargs)


def MobileCLIP2_L14(pretrained=False, use_ssld=False, **kwargs):
    return CLIP.from_variant("mobileclip2_l14", **kwargs)
