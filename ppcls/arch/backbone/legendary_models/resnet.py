...
class BottleneckBlock_new(TheseusLayer):
    def __init__(self,
        ...
        self.conv0 = ResNetUnit(
            ...
            filter_x_attr=ParamAttr(learning_rate=lr_mult),
            scale_x_attr=ParamAttr(learning_rate=lr_mult),
            bias_x_attr=ParamAttr(learning_rate=lr_mult),
        ...
        if not shortcut:
            ...
            self.conv2 = ResNetUnit(
                ...
                filter_z_attr=ParamAttr(learning_rate=lr_mult),
                scale_z_attr=ParamAttr(learning_rate=lr_mult),
                bias_z_attr=ParamAttr(learning_rate=lr_mult),
