...
from paddle.nn.initializer import Uniform, XavierNormal,Constant
...
class ConvBNLayer(nn.Layer):
    def __init__(self,
        ...
        #self.relu = nn.ReLU()
        #self.relu = nn.PReLU(num_parameters=1)
...
class ResNet(nn.Layer):
    ...
    def __init__(self,
        ...
        self.fc = Linear(
            ...
            self.class_num,
            weight_attr=ParamAttr(initializer=XavierNormal(fan_in=0.0)),
...
def my_ResNet50(pretrained=False, use_ssld=False, **kwargs):
    """
    ResNet50
    Args:
        pretrained: bool=False or str. If `True` load pretrained parameters, `False` otherwise.
