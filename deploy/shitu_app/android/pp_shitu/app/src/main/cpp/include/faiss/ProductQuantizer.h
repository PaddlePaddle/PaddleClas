...
struct ProductQuantizer {
  ...
  void compute_codes_with_assign_index(const float *x, uint8_t *codes,
                                       size_t n);
   ...
   */
  void compute_distance_tables(size_t nx, const float *x,
                               float *dis_tables) const;

  void compute_inner_prod_tables(size_t nx, const float *x,
                                 float *dis_tables) const;
  ...
  void search_sdc(const uint8_t *qcodes, size_t nq, const uint8_t *bcodes,
                  const size_t ncodes, float_maxheap_array_t *res,
                  bool init_finalize_heap = true) const;
