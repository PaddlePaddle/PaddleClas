...
struct IndexIVFPQ : IndexIVF {
  ...
  IndexIVFPQ(Index *quantizer, size_t d, size_t nlist, size_t M,
             size_t nbits_per_idx);

  void add_with_ids(idx_t n, const float *x,
                    const idx_t *xids = nullptr) override;
  ...
  void add_core_o(idx_t n, const float *x, const idx_t *xids,
                  float *residuals_2, const idx_t *precomputed_idx = nullptr);
  ...
  void decode_multiple(size_t n, const idx_t *keys, const uint8_t *xcodes,
                       float *x) const;
...
struct IndexIVFPQR : IndexIVFPQ {
  ...
  IndexIVFPQR(Index *quantizer, size_t d, size_t nlist, size_t M,
              size_t nbits_per_idx, size_t M_refine,
...
struct Index2Layer : Index {
  ...
  Index2Layer(Index *quantizer, size_t nlist, int M,
