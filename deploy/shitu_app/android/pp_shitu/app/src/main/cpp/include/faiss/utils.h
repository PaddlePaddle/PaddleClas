...
void pairwise_L2sqr(int64_t d, int64_t nq, const float *xq, int64_t nb,
                    const float *xb, float *dis, int64_t ldq = -1,
...
void fvec_L2sqr_ny(float *dis, const float *x, const float *y, size_t d,
                   size_t ny);
...
void inner_product_to_L2sqr(float *dis, const float *nr1, const float *nr2,
                            size_t n1, size_t n2);
...
void fvec_inner_products_by_idx(float *ip, const float *x, const float *y,
                                const int64_t *ids, size_t d, size_t nx,
                                size_t ny);

/* same but for a subset in y indexed by idsy (ny vectors in total) */
void fvec_L2sqr_by_idx(float *dis, const float *x, const float *y,
 ...
 */
void knn_inner_products_by_idx(const float *x, const float *y,
                               const int64_t *ids, size_t d, size_t nx,
                               size_t ny, float_minheap_array_t *res);
 ...
 */
int km_update_centroids(const float *x, float *centroids, int64_t *assign,
 ...
 */
size_t ranklist_intersection_size(size_t k1, const int64_t *v1, size_t k2,
                                  const int64_t *v2);
 ...
 */
size_t merge_result_table_with(size_t n, size_t k, int64_t *I0, float *D0,
                               const int64_t *I1, const float *D1,
                               bool keep_min = true, int64_t translation = 0);
