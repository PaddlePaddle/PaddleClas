 ...
 */
void search_and_return_centroids(Index *index, size_t n, const float *xin,
                                 long k, float *distances, idx_t *labels,
...
void search_with_parameters(const Index *index, idx_t n, const float *x,
