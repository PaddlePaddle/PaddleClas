...
struct ReconstructFromNeighbors {
  ...
  explicit ReconstructFromNeighbors(const IndexHNSW &index, size_t k = 256,
                                    size_t nsq = 1);
  ...
  size_t compute_distances(size_t n, const idx_t *shortlist, const float *query,
...
struct IndexHNSW : Index {
  ...
  /// alternative graph building
  void init_level_0_from_entry_points(int npt, const storage_idx_t *points,
