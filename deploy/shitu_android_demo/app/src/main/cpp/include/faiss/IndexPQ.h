...
struct IndexPQ : Index {
  ...
  void hamming_distance_histogram(idx_t n, const float *x, idx_t nb,
                                  const float *xb, int64_t *dist_histogram);
...
struct MultiIndexQuantizer2 : MultiIndexQuantizer {
  ...
  MultiIndexQuantizer2(int d, size_t nbits, Index *assign_index_0,
