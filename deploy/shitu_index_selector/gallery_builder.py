...
class GalleryBuilder(object):
    def __init__(self, config, index_out_dir):
        ...
        self.index_out_dir = index_out_dir

    def build(self, config, gallery_images, gallery_docs):
        '''
