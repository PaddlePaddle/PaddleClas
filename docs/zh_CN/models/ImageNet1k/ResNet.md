...
| ResNet18_dbb      | 0.70788           | 0.89848           | 0.7099                    | -                    | 1.818     | 11.688    |
...
另外，ResNet系列模型支持使用 DiverseBranchBlock 版本进行训练，使用方式请参考[ResNet18_dbb配置文件](../../../../ppcls/configs/ImageNet/ResNet/ResNet18_dbb.yaml)。
