...
| image_orientation |[PULC图像方向分类](PULC_image_orientation.md)|判断图片的方向| 89.99 |7.1M|2.16ms|[推理模型](https://paddleclas.bj.bcebos.com/models/PULC/inference/image_orientation_infer.tar) / [预训练模型](https://paddleclas.bj.bcebos.com/models/PULC/pretrained/image_orientation_pretrained.pdparams)|
