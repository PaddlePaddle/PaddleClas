...
```yaml
Global:
  infer_imgs: "./images/logo_demo_data_v1.0/query/" # 预测图像
...
IndexProcess:
  index_path: "./images/logo_demo_data_v1.0/index/" # 索引文件夹，用于识别特征提取之后的索引
  search_budget: 100
...
```shell
python3.7 python/predict_system.py -c configs/inference_logo.yaml -o Global.infer_imgs="./images/logo_demo_data_v1.0/query"
```
