...
* [3. 未知类别的图像识别体验](#未知类别的图像识别体验)
  * [3.1 基于自己的数据集构建底库](#基于自己的数据集构建底库)
  * [3.2 识别未知类别的图像](识别未知类别的图像)
...
首先需要获取待入库的原始图像文件(保存在`./dataset/logo_demo_data_v1.0/gallery`文件夹中)以及对应的标签信息，记录原始图像文件的文件名与标签信息(保存在文本文件[data_file_update.txt](./dataset/logo_demo_data_v1.0/data_file_update.txt)。
